...
lyr_009_KIRBA_4.set('fieldAliases', {'Class_Name': 'Class_Name', 'С т': 'С т', 'Регио': 'Регио', });
lyr_008_Koybal_5.set('fieldAliases', {'Class_Name': 'Class_Name', 'С т': 'С т', 'Регио': 'Регио', });
lyr_001SB_002_6.set('fieldAliases', {'Class_Name': 'Class_Name', 'С т': 'С т', 'Регио': 'Регио', });
lyr_003SM_001_7.set('fieldAliases', {'Class_Name': 'Class_Name', 'С т': 'С т', 'Регио': 'Регио', });
lyr_002SM_001_8.set('fieldAliases', {'Class_Name': 'Class_Name', 'С т': 'С т', 'Регио': 'Регио', });
lyr_001SM_001_9.set('fieldAliases', {'Class_Name': 'Class_Name', 'С т': 'С т', 'Регио': 'Регио', });
lyr_003VB_001_10.set('fieldAliases', {'Class_Name': 'Class_Name', 'С т': 'С т', 'Регио': 'Регио', });
lyr_002VB_001_11.set('fieldAliases', {'Class_Name': 'Class_Name', 'С т': 'С т', 'Регио': 'Регио', });
lyr_001VB_001_12.set('fieldAliases', {'Class_Name': 'Class_Name', 'C т': 'C т', 'Регио': 'Регио', });
...
lyr_009_KIRBA_4.set('fieldImages', {'Class_Name': 'TextEdit', 'С т': '', 'Регио': '', });
lyr_008_Koybal_5.set('fieldImages', {'Class_Name': 'TextEdit', 'С т': '', 'Регио': '', });
lyr_001SB_002_6.set('fieldImages', {'Class_Name': 'TextEdit', 'С т': '', 'Регио': '', });
lyr_003SM_001_7.set('fieldImages', {'Class_Name': 'TextEdit', 'С т': '', 'Регио': '', });
lyr_002SM_001_8.set('fieldImages', {'Class_Name': 'TextEdit', 'С т': '', 'Регио': '', });
lyr_001SM_001_9.set('fieldImages', {'Class_Name': 'TextEdit', 'С т': '', 'Регио': '', });
lyr_003VB_001_10.set('fieldImages', {'Class_Name': 'TextEdit', 'С т': '', 'Регио': '', });
lyr_002VB_001_11.set('fieldImages', {'Class_Name': 'TextEdit', 'С т': '', 'Регио': '', });
lyr_001VB_001_12.set('fieldImages', {'Class_Name': 'TextEdit', 'C т': 'TextEdit', 'Регио': '', });
lyr_Regions_13.set('fieldImages', {'Name': 'TextEdit', });
lyr__1.set('fieldLabels', {'name_ru': 'no label', });
lyr__2.set('fieldLabels', {'name': 'no label', });
lyr__3.set('fieldLabels', {'Name_ru': 'no label', });
lyr_009_KIRBA_4.set('fieldLabels', {'Class_Name': 'header label - visible with data', 'С т': 'header label - visible with data', 'Регио': 'no label', });
lyr_008_Koybal_5.set('fieldLabels', {'Class_Name': 'header label - visible with data', 'С т': 'header label - visible with data', 'Регио': 'no label', });
lyr_001SB_002_6.set('fieldLabels', {'Class_Name': 'header label - visible with data', 'С т': 'header label - visible with data', 'Регио': 'no label', });
lyr_003SM_001_7.set('fieldLabels', {'Class_Name': 'header label - visible with data', 'С т': 'header label - visible with data', 'Регио': 'no label', });
lyr_002SM_001_8.set('fieldLabels', {'Class_Name': 'header label - visible with data', 'С т': 'header label - visible with data', 'Регио': 'no label', });
lyr_001SM_001_9.set('fieldLabels', {'Class_Name': 'header label - visible with data', 'С т': 'header label - visible with data', 'Регио': 'no label', });
lyr_003VB_001_10.set('fieldLabels', {'Class_Name': 'header label - visible with data', 'С т': 'header label - visible with data', 'Регио': 'no label', });
lyr_002VB_001_11.set('fieldLabels', {'Class_Name': 'header label - visible with data', 'С т': 'header label - visible with data', 'Регио': 'no label', });
lyr_001VB_001_12.set('fieldLabels', {'Class_Name': 'header label - visible with data', 'C т': 'header label - visible with data', 'Регио': 'no label', });
